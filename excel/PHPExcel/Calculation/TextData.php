...
class TextData
{
        ...
        foreach ($aArgs as $arg) {
            if (\is_bool($arg)) {
                if (\PhpOffice\PhpSpreadsheet\Calculation\Functions::getCompatibilityMode() == \PhpOffice\PhpSpreadsheet\Calculation\Functions::COMPATIBILITY_OPENOFFICE) {
                    ...
                    $arg = ($arg) ? \PhpOffice\PhpSpreadsheet\Calculation\Calculation::getTRUE() : \PhpOffice\PhpSpreadsheet\Calculation\Calculation::getFALSE();
                }
            }
            $returnValue .= $arg;
        }
    ...
    public static function TEXTFORMAT($value, $format)
    {
        ...
        return (string) \PhpOffice\PhpSpreadsheet\Style\NumberFormat::toFormattedString($value, $format, null);
    }
    ...
    public static function VALUE($value = '')
    {
        ...
        if (!\is_numeric($value)) {
            ...
            $dateSetting = \PhpOffice\PhpSpreadsheet\Calculation\Functions::getReturnDateType();
            ...
            if (\strpos($value, ':') !== \false) {
                ...
                if ($timeValue !== \PhpOffice\PhpSpreadsheet\Calculation\Functions::VALUE()) {
                    \PhpOffice\PhpSpreadsheet\Calculation\Functions::setReturnDateType($dateSetting);
                    return $timeValue;
                }
            }

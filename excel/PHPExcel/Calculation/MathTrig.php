...
class MathTrig
{
    ...
    public static function FACT($factVal)
    {
        ...
        if (\is_numeric($factVal)) {
            ...
            if (\PhpOffice\PhpSpreadsheet\Calculation\Functions::getCompatibilityMode() == \PhpOffice\PhpSpreadsheet\Calculation\Functions::COMPATIBILITY_GNUMERIC && $factVal > $factLoop) {
                return \PhpOffice\PhpSpreadsheet\Calculation\Functions::NaN();
            }
    ...
    public static function GCD()
    {
        ...
        if ($mergedArrayValues == 0) {
            ...
            foreach ($mergedArray as $mergedKey => $mergedValue) {
                foreach ($allValuesFactors as $allValueFactor) {
                    foreach ($allValueFactor as $testKey => $testValue) {
            ...
            foreach ($allValuesFactors as $allValueFactor) {
                foreach ($allValueFactor as $mergedKey => $mergedValue) {
    ...
    public static function MDETERM($matrixValues)
    {
        ...
        foreach ($matrixValues as $matrixValue) {
            if (!\is_array($matrixValue)) {
                $matrixValue = array($matrixValue);
            }
            $column = 0;
            foreach ($matrixValue as $singleMatrixValue) {
                if ((\is_string($singleMatrixValue)) || ($singleMatrixValue === \null)) {
                    return \PhpOffice\PhpSpreadsheet\Calculation\Functions::VALUE();
                }
                $matrixData[$column][$row] = $singleMatrixValue;
                ++$column;
            }
            if ($column > $maxColumn) {
                $maxColumn = $column;
        ...
        try {
            $phpExcelSharedJAMAMatrix = new \PhpOffice\PhpSpreadsheet\Shared\JAMA\Matrix($matrixData);
            return $phpExcelSharedJAMAMatrix->det();
    ...
    public static function MINVERSE($matrixValues)
    {
        ...
        try {
            $phpExcelSharedJAMAMatrix = new \PhpOffice\PhpSpreadsheet\Shared\JAMA\Matrix($matrixData);
            return $phpExcelSharedJAMAMatrix->inverse()->getArray();
        } catch (\PhpOffice\PhpSpreadsheet\Exception $ex) {
            return \PhpOffice\PhpSpreadsheet\Calculation\Functions::VALUE();
        }
    }
    ...
    public static function MMULT($matrixData1, $matrixData2)
    {
        ...
        try {
            ...
            foreach ($matrixData1 as $matrixRow) {
                ...
                $columnA = 0;
                foreach ($matrixRow as $singleMatrixRow) {
                    if ((!\is_numeric($singleMatrixRow)) || ($singleMatrixRow === \null)) {
                        return \PhpOffice\PhpSpreadsheet\Calculation\Functions::VALUE();
                    }
                    $matrixAData[$rowA][$columnA] = $singleMatrixRow;
                    ++$columnA;
                }
                ++$rowA;
            }
            ...
            foreach ($matrixData2 as $matrixRow) {
                ...
                foreach ($matrixRow as $singleMatrixRow) {
                    ...
                    $matrixBData[$rowB][$columnB] = $singleMatrixRow;
                    ++$columnB;
                }
                ++$rowB;
            }
    ...
    public static function SUMPRODUCT()
    {
        ...
        foreach ($arrayList as $singleArrayList) {
            $array2 = \PhpOffice\PhpSpreadsheet\Calculation\Functions::flattenArray($singleArrayList);
            $count = \count($array2);

...
class DataSeries
{
     ...
     * @return string
     */
    public function isPlotGrouping()
    {
     ...
     * @return string
     */
    public function isPlotDirection()
    {
    ...
    public function refresh(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet)
    {
        foreach ($this->plotValues as $plotValue) {
            if ($plotValue !== \null) {
                $plotValue->refresh($phpExcelWorksheet, \true);
            }
        }
        foreach ($this->plotLabel as $singlePlotLabel) {
            if ($singlePlotLabel !== \null) {
                $singlePlotLabel->refresh($phpExcelWorksheet, \true);
            }
        }
        foreach ($this->plotCategory as $singlePlotCategory) {
            if ($singlePlotCategory !== \null) {
                $singlePlotCategory->refresh($phpExcelWorksheet, \false);
            }
        }
    }
}

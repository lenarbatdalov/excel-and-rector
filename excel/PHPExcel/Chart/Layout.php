...
class Layout
{
     ...
     * @return boolean
     */
    public function isShowLegendKey()
    {
     ...
     * @return boolean
     */
    public function isShowBubbleSize()
    {
     ...
     * @return boolean
     */
    public function isShowLeaderLines()
    {

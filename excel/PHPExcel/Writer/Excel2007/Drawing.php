...
class Drawing extends \PhpOffice\PhpSpreadsheet\Writer\Xlsx\WriterPart
{
     ...
     */
    public function writeDrawings(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pWorksheet = \null, &$chartRef, $includeCharts = \false)
    {
        // Create XML writer
        $objWriter = \null;
     ...
     * @throws     \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    public function writeChart(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Chart\Chart $pChart = \null, $pRelationId = -1)
    {
        ...
        $objWriter->startElement('xdr:twoCellAnchor');
            ...
            $objWriter->startElement('xdr:from');
                $objWriter->writeElement('xdr:col', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($tl['colRow'][0]) - 1);
            ...
            $objWriter->startElement('xdr:to');
                $objWriter->writeElement('xdr:col', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($br['colRow'][0]) - 1);
     ...
     * @throws     \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    public function writeDrawing(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing $pDrawing = \null, $pRelationId = -1)
    {
        if ($pRelationId >= 0) {
            // xdr:oneCellAnchor
            $objWriter->startElement('xdr:oneCellAnchor');
            // Image location
            $aCoordinates         = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::coordinateFromString($pDrawing->getCoordinates());
...
*/
     ...
     * @throws     \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeVMLHeaderFooterImage(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, $pReference = '', \PhpOffice\PhpSpreadsheet\Worksheet\HeaderFooterDrawing $pImage = \null)
    {
        // Calculate object id
     ...
     * @throws     \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    public function allDrawings(\PhpOffice\PhpSpreadsheet\Spreadsheet $pPHPExcel = \null)
    {
        // Get an array of all drawings
        $aDrawings    = array();

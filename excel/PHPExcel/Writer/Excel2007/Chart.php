...
class Chart extends \PhpOffice\PhpSpreadsheet\Writer\Xlsx\WriterPart
{
     ...
     */
    public function writeChart(\PhpOffice\PhpSpreadsheet\Chart\Chart $phpExcelChart = \null, $calculateCellValues = \true)
    {
        ...
        $this->writeTitle($phpExcelChart->getTitle(), $objWriter);

        $objWriter->startElement('c:autoTitleDeleted');
        $objWriter->writeAttribute('val', 0);
        $objWriter->endElement();

        $this->writePlotArea($phpExcelChart->getPlotArea(), $phpExcelChart->getXAxisLabel(), $phpExcelChart->getYAxisLabel(), $objWriter, $phpExcelChart->getWorksheet(), $phpExcelChart->getChartAxisX(), $phpExcelChart->getChartAxisY(), $phpExcelChart->getMajorGridlines(), $phpExcelChart->getMinorGridlines());

        $this->writeLegend($phpExcelChart->getLegend(), $objWriter);
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeTitle(\PhpOffice\PhpSpreadsheet\Chart\Title $phpExcelChartTitle = \null, $objWriter)
    {
        if (\is_null($phpExcelChartTitle)) {
            return;
        }
        ...
        $caption = $phpExcelChartTitle->getCaption();
        ...
        $this->writeLayout($phpExcelChartTitle->getLayout(), $objWriter);
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeLegend(\PhpOffice\PhpSpreadsheet\Chart\Legend $phpExcelChartLegend = \null, $objWriter)
    {
        if (\is_null($phpExcelChartLegend)) {
            return;
        }
        ...
        $objWriter->writeAttribute('val', $phpExcelChartLegend->getPosition());
        $objWriter->endElement();

        $this->writeLayout($phpExcelChartLegend->getLayout(), $objWriter);

        $objWriter->startElement('c:overlay');
        $objWriter->writeAttribute('val', ($phpExcelChartLegend->isOverlay()) ? '1' : '0');
        $objWriter->endElement();
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePlotArea(\PhpOffice\PhpSpreadsheet\Chart\PlotArea $phpExcelChartPlotArea, \PhpOffice\PhpSpreadsheet\Chart\Title $xAxisLabel = \null, \PhpOffice\PhpSpreadsheet\Chart\Title $yAxisLabel = \null, $objWriter, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet, \PhpOffice\PhpSpreadsheet\Chart\Axis $xAxis, \PhpOffice\PhpSpreadsheet\Chart\Axis $yAxis, \PhpOffice\PhpSpreadsheet\Chart\GridLines $majorGridlines, \PhpOffice\PhpSpreadsheet\Chart\GridLines $minorGridlines)
    {
        if (\is_null($phpExcelChartPlotArea)) {
            return;
        }
        ...
        $layout = $phpExcelChartPlotArea->getLayout();

        $this->writeLayout($layout, $objWriter);

        $chartTypes = self::getChartType($phpExcelChartPlotArea);
        $catIsMultiLevelSeries = $valIsMultiLevelSeries = \false;
        $plotGroupingType = '';
        foreach ($chartTypes as $chartType) {
            $objWriter->startElement('c:' . $chartType);

            $groupCount = $phpExcelChartPlotArea->getPlotGroupCount();
            for ($i = 0; $i < $groupCount; ++$i) {
                $plotGroup = $phpExcelChartPlotArea->getPlotGroupByIndex($i);
                $groupType = $plotGroup->getPlotType();
                if ($groupType == $chartType) {
                    $plotStyle = $plotGroup->getPlotStyle();
                    if ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_RADARCHART) {
                        $objWriter->startElement('c:radarStyle');
                        $objWriter->writeAttribute('val', $plotStyle);
                        $objWriter->endElement();
                    } elseif ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_SCATTERCHART) {
                        $objWriter->startElement('c:scatterStyle');
                        $objWriter->writeAttribute('val', $plotStyle);
                        $objWriter->endElement();
                    }

                    $this->writePlotGroup($plotGroup, $chartType, $objWriter, $catIsMultiLevelSeries, $valIsMultiLevelSeries, $plotGroupingType, $phpExcelWorksheet);
                }
            }

            $this->writeDataLabels($objWriter, $layout);

            if ($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_LINECHART) {
                //    Line only, Line3D can't be smoothed

                $objWriter->startElement('c:smooth');
                $objWriter->writeAttribute('val', (integer) $plotGroup->getSmoothLine());
                $objWriter->endElement();
            } elseif (($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART) ||($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART_3D)) {
            ...
            } elseif ($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) {
                ...
                $objWriter->writeAttribute('val', 0);
                $objWriter->endElement();
            } elseif ($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_STOCKCHART) {
            ...
            if (($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) && ($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) && ($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART)) {
                ...
                if ($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART) {
        ...
        if (($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) && ($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) && ($chartType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART)) {
            if ($chartType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) {
                $this->writeValueAxis($objWriter, $phpExcelChartPlotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
            } else {
                $this->writeCategoryAxis($objWriter, $phpExcelChartPlotArea, $xAxisLabel, $chartType, $id1, $id2, $catIsMultiLevelSeries, $xAxis, $yAxis);
            }

            $this->writeValueAxis($objWriter, $phpExcelChartPlotArea, $yAxisLabel, $chartType, $id1, $id2, $valIsMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines);
        }
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter XML Writer
     * @param  \PhpOffice\PhpSpreadsheet\Chart\Title $xAxisLabel
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeCategoryAxis($objWriter, \PhpOffice\PhpSpreadsheet\Chart\PlotArea $phpExcelChartPlotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis)
    {
        ...
        if (!\is_null($xAxisLabel)) {
            ...
            $phpExcelChartLayout = $xAxisLabel->getLayout();
            $this->writeLayout($phpExcelChartLayout, $objWriter);
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter XML Writer
     * @param  \PhpOffice\PhpSpreadsheet\Chart\Title $yAxisLabel
     * @param  string $groupType Chart type
     * @param  string $id1
     * @param  string $id2
     * @param  boolean $isMultiLevelSeries
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeValueAxis($objWriter, \PhpOffice\PhpSpreadsheet\Chart\PlotArea $phpExcelChartPlotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines)
    {
        ...
        if (!\is_null($yAxisLabel)) {
            ...
            if ($groupType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) {
                $phpExcelChartLayout = $yAxisLabel->getLayout();
                $this->writeLayout($phpExcelChartLayout, $objWriter);
            }
        ...
        if ($isMultiLevelSeries && $groupType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) {
            $objWriter->startElement('c:noMultiLvlLbl');
            $objWriter->writeAttribute('val', 0);
            $objWriter->endElement();
        }
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea
     *
     * @return  string|array
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Chart\DataSeries $plotGroup
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet)
    {
        if (\is_null($plotGroup)) {
            return;
        }

        if (($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART_3D)) {
            $objWriter->startElement('c:barDir');
            $objWriter->writeAttribute('val', $plotGroup->isPlotDirection());
            $objWriter->endElement();
        }

        if (!\is_null($plotGroup->isPlotGrouping())) {
            $plotGroupingType = $plotGroup->isPlotGrouping();
        ...
        $plotOrder = $plotGroup->getPlotOrder();
        $plotSeriesCount = \count($plotOrder);

        if (($groupType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_RADARCHART) && ($groupType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_STOCKCHART) && $groupType !== \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_LINECHART) {
            if (($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART) || ($plotSeriesCount > 1)) {
        ...
        foreach ($plotOrder as $plotSeriesIdx => $plotSeriesRef) {
            ...
            if (($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART)) {
            ...
            if (($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_LINECHART) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_STOCKCHART)) {
                $objWriter->startElement('c:spPr');
                $objWriter->startElement('a:ln');
                $objWriter->writeAttribute('w', 12700);
                if ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_STOCKCHART) {
            ...
            if (($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART) || ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BARCHART_3D) || ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART)) {
            ...
            if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0)) {
                ...
                if ((($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) || ($groupType == \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART)) && !\is_null($plotGroup->getPlotStyle())) {
                    $plotStyle = $plotGroup->getPlotStyle();
                    if ($plotStyle !== '') {
                ...
                if (($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) || ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_SCATTERCHART)) {
                    $objWriter->startElement('c:xVal');
                } else {
                    $objWriter->startElement('c:cat');
                }

                $this->writePlotSeriesValues($plotSeriesCategory, $objWriter, $groupType, 'str', $phpExcelWorksheet);
                $objWriter->endElement();
            }
            ...
            if ($plotSeriesValues) {
                ...
                $this->writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, 'num', $phpExcelWorksheet);
                $objWriter->endElement();
            }

            if ($groupType === \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_BUBBLECHART) {
                $this->writeBubbles($plotSeriesValues, $objWriter, $phpExcelWorksheet);
            }
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues $plotSeriesLabel
     * @param  \PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter XML Writer
     *
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
     ...
     *
     * @param  \PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues $plotSeriesValues
     * @param  \PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter XML Writer
     * @param  string $groupType Type of plot for dataseries
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet)
    {
        ...
        if ($plotSeriesValues->isMultiLevelSeries()) {
            ...
            if (($groupType != \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART) && ($groupType != \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_PIECHART_3D) && ($groupType != \PhpOffice\PhpSpreadsheet\Chart\DataSeries::TYPE_DONUTCHART) && (($plotSeriesValues->getFormatCode() !== \null) && ($plotSeriesValues->getFormatCode() !== ''))) {
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeBubbles($plotSeriesValues, $objWriter, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet)
    {
        if (\is_null($plotSeriesValues)) {
            return;
        }
     ...
     * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeLayout(\PhpOffice\PhpSpreadsheet\Chart\Layout $phpExcelChartLayout = \null, $objWriter)
    {
        $objWriter->startElement('c:layout');

        if (!\is_null($phpExcelChartLayout)) {
            $objWriter->startElement('c:manualLayout');

            $layoutTarget = $phpExcelChartLayout->getLayoutTarget();
            ...
            $xMode = $phpExcelChartLayout->getXMode();
            if (!\is_null($xMode)) {
            ...
            $yMode = $phpExcelChartLayout->getYMode();
            if (!\is_null($yMode)) {
            ...
            $x = $phpExcelChartLayout->getXPosition();
            if (!\is_null($x)) {
            ...
            $y = $phpExcelChartLayout->getYPosition();
            if (!\is_null($y)) {
            ...
            $w = $phpExcelChartLayout->getWidth();
            if (!\is_null($w)) {
            ...
            $h = $phpExcelChartLayout->getHeight();
            if (!\is_null($h)) {

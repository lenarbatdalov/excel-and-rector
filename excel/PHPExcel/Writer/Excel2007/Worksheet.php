...
class Worksheet extends \PhpOffice\PhpSpreadsheet\Writer\Xlsx\WriterPart
{
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeSheetPr(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // sheetPr
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeDimension(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // dimension
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeSheetViews(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // sheetViews
...
//      }
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeSheetFormatPr(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // sheetFormatPr
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeCols(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // cols
        if (\count($pSheet->getColumnDimensions()) > 0) {
            ...
            foreach ($pSheet->getColumnDimensions() as $colDimension) {
                ...
                $objWriter->writeAttribute('min', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($colDimension->getColumnIndex()));
                $objWriter->writeAttribute('max', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($colDimension->getColumnIndex()));
                ...
                // Collapsed
                if ($colDimension->getCollapsed() == \true) {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeSheetProtection(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // sheetProtection
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeConditionalFormatting(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // Conditional id
        $id = 1;
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeDataValidations(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeHyperlinks(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeProtectedRanges(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeMergeCells(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePrintOptions(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // printOptions
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePageMargins(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // pageMargins
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeAutoFilter(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        $autoFilterRange = $pSheet->getAutoFilter()->getRange();
        if (!empty($autoFilterRange)) {
            // autoFilter
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writePageSetup(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // pageSetup
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeHeaderFooter(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        // headerFooter
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeBreaks(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
        ...
        if (!empty($aRowBreaks)) {
            ...
            foreach ($aRowBreaks as $cell) {
                $coords = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::coordinateFromString($cell);
        ...
        if (!empty($aColumnBreaks)) {
            ...
            foreach ($aColumnBreaks as $cell) {
                ...
                $objWriter->startElement('brk');
                $objWriter->writeAttribute('id', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($coords[0]) - 1);
                $objWriter->writeAttribute('man', '1');
                $objWriter->endElement();
            }
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeSheetData(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null, $pStringTable = \null)
    {
        if (\is_array($pStringTable)) {
            ...
            // Get column count
            $colCount = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($pSheet->getHighestColumn());
            ...
            // Loop through cells
            $cellsByRow = array();
            foreach ($pSheet->getCoordinates() as $cellID) {
            ...
            while ($currentRow++ < $highestRow) {
                // Get row dimension
                $rowDimension = $pSheet->getRowDimension($currentRow, true);

                // Write current row?
                $writeCurrentRow = isset($cellsByRow[$currentRow]) || $rowDimension->getRowHeight() >= 0 || $rowDimension->getVisible() == \false || $rowDimension->getCollapsed() == \true || $rowDimension->getOutlineLevel() > 0 || $rowDimension->getXfIndex() !== \null;
                ...
                if ($writeCurrentRow) {
                    ...
                    // Collapsed
                    if ($rowDimension->getCollapsed() == \true) {
                        $objWriter->writeAttribute('collapsed', 'true');
                    }
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeCell(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null, $pCellAddress = \null, $pStringTable = \null, $pFlippedStringTable = \null)
    {
        if (\is_array($pStringTable) && \is_array($pFlippedStringTable)) {
            // Cell
            $pCell = $pSheet->getCell($pCellAddress, true);
...
//                                $calculatedValue = $pCell->getCalculatedValue();
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeDrawings(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null, $includeCharts = \false)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeLegacyDrawing(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {
     ...
     * @throws    \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function writeLegacyDrawingHF(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter = \null, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet = \null)
    {

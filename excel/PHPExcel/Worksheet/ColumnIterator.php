...
class ColumnIterator implements \Iterator
{
    ...
    public function resetStart($startColumn = 'A')
    {
        ...
        if ($startColumnIndex > \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($this->subject->getHighestColumn()) - 1) {
            throw new \PhpOffice\PhpSpreadsheet\Exception("Start column ({$startColumn}) is beyond highest column ({$this->subject->getHighestColumn()})");
        }
    ...
    {
        return new \PhpOffice\PhpSpreadsheet\Worksheet\Column($this->subject, \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($this->position));
    }

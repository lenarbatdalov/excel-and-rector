...
class Column
{
     ...
     */
    private $phpExcelWorksheetAutoFilter;
     ...
     *    @param \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter  $phpExcelWorksheetAutoFilter        Autofilter for this column
     */
    public function __construct($pColumn, \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter $phpExcelWorksheetAutoFilter = \null)
    {
        $this->columnIndex = $pColumn;
        $this->phpExcelWorksheetAutoFilter = $phpExcelWorksheetAutoFilter;
    }
    ...
    public function setColumnIndex($pColumn)
    {
        ...
        if ($this->phpExcelWorksheetAutoFilter !== \null) {
            $this->phpExcelWorksheetAutoFilter->testColumnInRange($pColumn);
        }
    ...
    {
        return $this->phpExcelWorksheetAutoFilter;
    }
     ...
     * @return \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column
     */
    public function setParent(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter $phpExcelWorksheetAutoFilter = \null)
    {
        $this->phpExcelWorksheetAutoFilter = $phpExcelWorksheetAutoFilter;
    ...
    public function getRule($pIndex)
    {
        if (!isset($this->ruleset[$pIndex])) {
            $this->ruleset[$pIndex] = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule($this);
        }
    ...
    {
        $this->ruleset[] = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule($this);
     ...
     * @return    \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column|\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule
     */
    public function addRule(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule $phpExcelWorksheetAutoFilterColumnRule, $returnRule = \true)
    {
        $phpExcelWorksheetAutoFilterColumnRule->setParent($this);
        $this->ruleset[] = $phpExcelWorksheetAutoFilterColumnRule;

        return ($returnRule) ? $phpExcelWorksheetAutoFilterColumnRule : $this;
    }
    ...
    public function deleteRule($pIndex)
    {
        if (isset($this->ruleset[$pIndex])) {
            ...
            if (\count($this->ruleset) <= 1) {
                $this->setJoin(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_OR);
            }
        }

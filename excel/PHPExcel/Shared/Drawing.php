...
class Drawing
{
     ...
     *
     * @param     int $pValue    Value in pixels
     * @param \PhpOffice\PhpSpreadsheet\Style\Font $phpExcelStyleFont    Default font of the workbook
     * @return     int            Value in cell dimension
     */
    public static function pixelsToCellDimension($pValue = 0, \PhpOffice\PhpSpreadsheet\Style\Font $phpExcelStyleFont)
    {
        // Font name and size
        $name = $phpExcelStyleFont->getName();
        $size = $phpExcelStyleFont->getSize();
     ...
     * @return     int        Value in pixels
     */
    public static function cellDimensionToPixels($pValue = 0, \PhpOffice\PhpSpreadsheet\Style\Font $phpExcelStyleFont)
    {
        // Font name and size
        $name = $phpExcelStyleFont->getName();
        $size = $phpExcelStyleFont->getSize();

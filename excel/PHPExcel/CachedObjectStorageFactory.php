...
class CellsFactory
{
     ...
     *
     * @param \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet     $phpExcelWorksheet        Enable cell caching for this worksheet
     * @return    PHPExcel_CachedObjectStorage_ICache
     **/
    public static function getInstance(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpExcelWorksheet)
    {
        $cacheMethodIsAvailable = \true;
        if (self::$cacheStorageMethod === \null) {
    ...
    {
        self::$cacheStorageMethod = \null;
        self::$cacheStorageClass = \null;

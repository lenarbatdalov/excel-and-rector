...
class Escher
{
    ...
    private function readDggContainer()
    {
        ...
        $this->object->setDggContainer($phpExcelSharedEscherDggContainer);
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($phpExcelSharedEscherDggContainer);
        $phpExcelReaderExcel5Escher->load($recordData);
    }
    ...
    private function readBstoreContainer()
    {
        ...
        $this->object->setBstoreContainer($phpExcelSharedEscherDggContainerBstoreContainer);
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($phpExcelSharedEscherDggContainerBstoreContainer);
        $phpExcelReaderExcel5Escher->load($recordData);
    }
    ...
    private function readBSE()
    {
        ...
        $phpExcelSharedEscherDggContainerBstoreContainerBSE = new \PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE();
        $this->object->addBSE($phpExcelSharedEscherDggContainerBstoreContainerBSE);

        $phpExcelSharedEscherDggContainerBstoreContainerBSE->setBLIPType($recInstance);
        ...
        // record is a container, read contents
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($phpExcelSharedEscherDggContainerBstoreContainerBSE);
        $phpExcelReaderExcel5Escher->load($blipData);
    }
    ...
    private function readBlipJPEG()
    {
        ...
        $phpExcelSharedEscherDggContainerBstoreContainerBSEBlip = new \PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip();
        $phpExcelSharedEscherDggContainerBstoreContainerBSEBlip->setData($data);

        $this->object->setBlip($phpExcelSharedEscherDggContainerBstoreContainerBSEBlip);
    }
    ...
    private function readDgContainer()
    {
        ...
        // record is a container, read contents
        $phpExcelSharedEscherDgContainer = new \PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer();
        $this->object->setDgContainer($phpExcelSharedEscherDgContainer);
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($phpExcelSharedEscherDgContainer);
        $escher = $phpExcelReaderExcel5Escher->load($recordData);
    }
    ...
    private function readSpgrContainer()
    {
        ...
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($spgrContainer);
        $escher = $phpExcelReaderExcel5Escher->load($recordData);
    }
    ...
    private function readSpContainer()
    {
        ...
        $phpExcelSharedEscherDgContainerSpgrContainerSpContainer = new \PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer();
        $this->object->addChild($phpExcelSharedEscherDgContainerSpgrContainerSpContainer);

        // move stream pointer to next record
        $this->pos += 8 + $length;

        // record is a container, read contents
        $phpExcelReaderExcel5Escher = new \PhpOffice\PhpSpreadsheet\Reader\Xls\Escher($phpExcelSharedEscherDgContainerSpgrContainerSpContainer);
        $escher = $phpExcelReaderExcel5Escher->load($recordData);
    }
    ...
    private function readClientAnchor()
    {
        ...
        $this->object->setStartCoordinates(\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($c1) . ($r1 + 1));
        ...
        $this->object->setEndCoordinates(\PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($c2) . ($r2 + 1));
